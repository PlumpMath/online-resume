...
function drawTimeline() {
    ...
    data.addRows([
        ...
        [new Date(), , '<img src="http://backoffice.adikteev.com/assets/logos/logo-def_couleur.png" style="width:32px; height:32px; vertical-align: middle"> Adikteev 😀', 'floatingRange'],
    ]);
